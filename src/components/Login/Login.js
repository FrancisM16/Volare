                    ...
                    <div className="mt-4">
                        <form className="space-y-6 " onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="grid justify-items-center space-x-0 space-y-6 md:flex md:items-center md:space-y-0 md:space-x-4">
                                <button className="border rounded-md py-2 px-4 text-white bg-violet-900 hover:bg-black md:w-fit w-full" type="submit">Iniciar sesión</button>
                                <div className="text-center">
                                    <Link to="/register" className=" hover:text-violet-900">Registrarme</Link>
                                </div>
                            </div>
                        </form>
                    </div>
