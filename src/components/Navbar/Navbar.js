    ...
    return (
        <nav className={`w-full font-default z-[1] top-0 sticky`}>
            <div className="md:flex items-center justify-between bg-violet-100 px-0 md:px-8 py-4">
                ...
                <ul className={`md:flex md:items-center absolute md:static bg-violet-50 md:bg-transparent w-full z-[-1] py-8 space-y-4 md:space-y-0 md:py-0 md:z-0 md:w-fit duration-500 ease-in ${toggle ? 'top-16 ' : 'top-[-400px]'}`}>
